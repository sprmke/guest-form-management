...
1. ✅ **Phase 0 — Backup & schema.** Snapshot **`guest_submissions_backup_20260501`** (`20260501000000_*`); nullable workflow columns + approved/request PDF URLs + `processed_emails` + `gmail_listener_state` + four storage buckets (`20260501000002`–`20260501000010`). **`20260428120000_*`** (`PENDING_DOCUMENTS`) runs **before** that batch in filename order. No app-code requirement by itself — see **`docs/operations/migration-runbook.md` §1**.
...
See **`docs/operations/production-deployment.md`** for the **ordered production cutover** (backups, CLI, secrets, Google, UI, cron). See **`docs/operations/migration-runbook.md`** for migration detail, verification queries, Phase 0 rollback caveats, and **§1.3** follow-on migrations.
