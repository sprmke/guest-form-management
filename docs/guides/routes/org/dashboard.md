...
| Stat cards               | —        | —          | Done | Revenue, bookings, properties, occupancy |
...
| **Occupancy Rate**   | `kpis.occupancyRate`    | Org-wide occupied nights ÷ (period days × property count is **not** applied — nights ÷ period days across aggregated stays) |
...
| Status labels / colors | `ui/src/features/dashboard/bookings/lib/bookingStatus.ts`, `StatusBadge.tsx`              |
