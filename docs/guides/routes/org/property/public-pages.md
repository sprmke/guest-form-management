...
| ------------------ | -------- | ---------- | ---------- | ---------------------------------------------------------------------- |
| Design your pages  | —        | —          | Documented | Property + Stay Guide + Showcase; Edit + last-edited from page configs |
...
| Showcase editor    | autosave | Growth+    | Documented | Template picker, publish, sections/style; see property-showcase guide  |
...
1. **Design your pages** — Property + Stay Guide + Showcase. Larger cards; primary **Edit** (Showcase may show **Upgrade** when locked); Copy / Open as icon buttons. Showcase shows a **Published** / **Draft** chip. Meta line: **Last edited {relative}** from `public_page_configs.updated_at`, or **Not customized yet** when config is still defaults. Grid: 1 column on phone, 2 from `sm`.
...
| Chrome             | Behavior                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Editor header      | Back → gallery (blocked by a leave-confirmation dialog if there are unsaved changes — see Save row); title **Edit - Property** / **Edit - Stay Guide** / **Edit - Showcase**; **Unsaved / Saving… / Saved** (upper right) on Starter+, a primary **Save** button on Free; undo/redo                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Rows are **lazily created on first read**. Showcase `template_key` ∈ `showcase-aurora` | `showcase-monolith` | `showcase-editorial`.
...
| Card          | `ui/src/features/dashboard/custom-pages/components/PublicPageCard.tsx` (`variant` editable \| static; optional `publishState` / `locked`)                                                 |
...
- Showcase on Free/Starter shows **Upgrade** instead of **Edit**; Growth+ shows **Published** / **Draft**.
