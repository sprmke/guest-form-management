...
| Leaf id                                         | Gates                                                  |
| ----------------------------------------------- | ------------------------------------------------------ |
| `marketing:view`                                | Nav + Content Studio shell; template list/history read |
| `marketing.content:add` / `:edit`               | Builder edits, autosave, Download PNG/MP4              |
