...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Calendar | **Calendar Builder** top bar — **mode tabs**, **autosave status**, Download PNG, Publish; **Templates** sidebar                               | **Live Preview** sub-header — Undo/Redo/Reset + month nav, zoom                                                            |
...
**Autosave:** Calendar, Design, and Video editors persist to `marketing_templates` automatically (~2.5s after the last edit). The toolbar shows **Unsaved** → **Saving…** → **Saved** (no manual Save button). First edit on a preset creates a saved row; further edits PATCH the open template. Sidebar **Save template** (Design/Video) remains for explicit duplicate saves with a custom name.
