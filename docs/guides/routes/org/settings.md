...
- Q: Do I need a logo?
  A: Yes. Upload your organization logo under Basic information. Guest forms, emails, and your public host page use it.
...
| ----------------- | ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Organization logo | `org_settings.email_logo_url`, `organizations.logo_url` | **Required.** JPEG/PNG/WebP upload via `upload-org-settings-asset` (immediate). Preview is a **1×1** tile (`object-cover`); guest/admin marks crop the same way. Platform default logo does not count. Clear/reset is blocked (UI + `org-settings` PATCH). Missing logo flags Basic information incomplete and blocks Basic profile saves.                                        |
