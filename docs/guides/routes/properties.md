...
| Reviews     | `PropertyReviews`                                                        | Merged Kame guest + approved external reviews (newest first); source badges; feedback tags; photos + lightbox; **See more** modal. No category bars, search, or helpful votes. |
