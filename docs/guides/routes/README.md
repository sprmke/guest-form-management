...
| `/org/:orgSlug/plans`                                                                                             | [org/plans.md](./org/plans.md)                                       | Documented — Pro/Business/Business Plus portfolio bundling             |
...
| `/org/:orgSlug/property/:propertySlug/plans`                                                                      | [org/property/plans.md](./org/property/plans.md)                     | Documented — Plans & Billing (subscription tiers)                      |
