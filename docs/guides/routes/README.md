...
| `/org/:orgSlug/activity`                                                                                          | [org/activity.md](./org/activity.md)                                 | Documented — read-only org-wide activity / audit timeline (`org.dashboard:view`)                               |
...
| `/org/:orgSlug/property/:propertySlug/activity`                                                                   | [org/property/activity.md](./org/property/activity.md)               | Documented — property-scoped activity timeline (`bookings:view`)                                               |
...
| `/org/:orgSlug/parking/:parkingSlug/activity`                                                                     | [org/parking/activity.md](./org/parking/activity.md)                 | Documented — parking-scoped activity timeline (coarse `bookings:view`)                                         |
