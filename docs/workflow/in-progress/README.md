...
| [`pricing-portfolio-bundling.md`](./pricing-portfolio-bundling.md)                     | Phases 1-4 shipped (schema, entitlements, checkout/webhook, org Plans UI), post-ship review hardening (atomic bundle creation, checkout-time ownership check, `business_plus` standalone-purchase fix); mid-bundle plan changes, org-level proration, billing-cycle automation open |
