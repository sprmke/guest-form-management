...
This plan is a continuation of `docs/workflow/planned/smart-search-bar.md` and should not start implementation until that plan has shipped. It reuses, rather than duplicates, the shared infrastructure that plan introduces:
