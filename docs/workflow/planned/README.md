...
| [`guest-inbox-meta-hardening.md`](./guest-inbox-meta-hardening.md)   | not started | 8-phase Meta (FB/IG) inbox hardening: webhook health-check/auto-resubscribe (fixes "must disconnect/reconnect for new messages"), non-destructive disconnect default, HUMAN_AGENT 7-day reply-window tag, comment-reply OAuth scope fix, pagination/caching/security hardening                                                    |
...
Moved to done: [`parking-e2e-phase1-overview.md`](../done/parking-e2e-phase1-overview.md) (+ 5 companions).
