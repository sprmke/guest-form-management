...
| [`ai-platform-hardening.md`](./ai-platform-hardening.md)                               | in progress | Harden AI foundation: unified kill switch, per-property quotas, feature allowlist, caching, token optimization (Phase A shared services + endpoints + UI shipped; migration applied; verification pending) |
