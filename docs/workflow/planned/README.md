...
| Plan                                                                                   | Status      | Summary                                                                                                                                                   |
| -------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`ai-usage-metering-credits-foundation.md`](./ai-usage-metering-credits-foundation.md) | not started | Per-feature AI usage/credit tracking, org+property limits, credit ledger foundation for a future paid-credits upsell                                      |
...
| [`paymongo-subscription-billing.md`](./paymongo-subscription-billing.md)               | not started | Host → platform subscription billing via PayMongo (Payment Links, QRPH/Maya/bank rails, webhook + cron renewal, super-admin plan/settings UI)             |
| [`host-plans-and-pricing-tiers.md`](./host-plans-and-pricing-tiers.md)                 | not started | Pricing tier catalog + per-property plan assignment + entitlement resolver, commission-pricing-compatible schema, super-admin plan CRUD                   |
| [`host-plans-pricing-page.md`](./host-plans-pricing-page.md)                           | not started | Host-facing property-scoped Plans page — tier comparison + review/confirm UX, Free tier assigns for real, paid tiers stub the payment step                |
