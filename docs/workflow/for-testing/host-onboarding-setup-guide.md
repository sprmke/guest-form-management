...
- **Ordering:** `welcome` → `org.brand` → property block(s) → parking block(s) → `org.verification`
...
`welcome`, `org.brand`, 7 × `property.<id>.*`, 6 × `parking.<id>.*`, `org.verification`,
`org.team`, `org.recommended`, `org.done`. Zero listings (edge case) → org group only.
...
| `components/SetupGuideLauncher.tsx`                                                   | Dashboard card + collapsed pill                                                                                                                                                                          |
...
| `ui/src/features/dashboard/org/pages/OrgDashboardPage.tsx`, `ui/src/features/dashboard/property/pages/DashboardPage.tsx` | Render `<SetupGuideLauncher />`                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- [x] `SetupGuideLauncher` on org + property + parking dashboards; sidebar "Finish setup" entry + dot.
