...
| `parking_owner`               | `TEXT`        | Owner or agent **display name** (who parking was obtained from). Captured in admin **`ParkingRequestForm`** above “Paid Parking Rate”. Distinct from legacy `parking_owner_email`.                                                                   |
...
| **Q4.5**             | **Display labels** (admin UI + guest-facing copy; DB columns stay `parking_rate_guest` / `parking_rate_paid`): **`parking_rate_guest` → “Guest Parking Rate”**; **`parking_rate_paid` → “Paid Parking Rate”**. Optional helper copy in admin form: **“parking amount paid to parking owners”**. Parking owner email selection is no longer captured in the admin workflow UI/API.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
