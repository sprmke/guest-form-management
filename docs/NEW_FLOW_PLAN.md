...
| **Q6.3 / Q6.4**      | Match Azure approval messages using **the same subject lines we already generate** in `supabase/functions/_shared/emailService.ts` today — i.e. subjects starting with `Monaco 2604 - GAF Request (`…`)` and `Monaco 2604 - Pet Request (`…`)` (with optional `🚨 URGENT -`, `(Updated)` prefixes). Attachment filename to treat as approved: **`APPROVED GAF.pdf`** (per `docs/NEW FLOW.md`).                                                                                                                                                                                                                                                                                                                                                                                                                                            |
