...
| **Email (Resend)**                 | **`RESEND_API_KEY`**, **`EMAIL_TO`**, **`EMAIL_REPLY_TO`**                                                                      | Production vs dev routing — see comments in **`.env.example`**.                                                                        |
...
| **Gmail listener / Connect Gmail** | **`PERMIT_APPROVER_EMAIL`**                                                                                                     | Comma-separated **visible `From`** addresses on Azure approval replies (see **`docs/PROJECT.md` §11**).                                |
