...
| `reorganize-env-files.mjs`             | (manual) `bun scripts/dev/reorganize-env-files.mjs`                   | Re-group gitignored UI/Supabase env files; drops keys not referenced in code (backup first under `.env-backups/`)                                                                                                                                                                                                                                                                             |
