...
| `seed-dashboard-demo-data.sql`         | (manual / `supabase/config.toml` `[db.seed]`)                         | Kame Homes bookings (Jul–Sep dense; Oct mostly 1-night + one 2/3-night) + finance + maintenance for local dashboards            |
