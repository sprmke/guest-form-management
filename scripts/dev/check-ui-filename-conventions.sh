...
# Exit 1 on violations. See docs/archive/reference/naming-audit.md for intentional exceptions.
...
if [[ "$VIOLATIONS" -gt 0 ]]; then
  echo ""
  echo "$VIOLATIONS naming violation(s). See docs/archive/reference/naming-audit.md"
  exit 1
fi
