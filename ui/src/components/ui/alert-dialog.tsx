...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // Above Dialog/ResponsiveModal (z-[100]/z-[101]); command palette stays higher (z-[120]+).
