import type { PropertyPaymentTransactionDto } from '@/features/dashboard/plans/lib/propertyPlanApi';

import { FloatingPanel } from '@/components/mobile/FloatingPanel';
import { Badge } from '@/components/ui/badge';
import { formatManilaLongDate } from '@/utils/format/dates';

type PropertyPlanTransactionsProps = {
...
export function PropertyPlanTransactions({ transactions }: PropertyPlanTransactionsProps) {
