  ...
  return (
    <AdminDataTable minWidth={640}>
      <AdminTableHeadRow>
        ...
        <AdminTableTh className="hidden px-3 text-right sm:table-cell sm:px-4">Orgs</AdminTableTh>
        <AdminTableTh className="hidden px-3 text-right md:table-cell md:px-4">
          Properties
        </AdminTableTh>
        <AdminTableTh className="hidden px-3 text-right lg:table-cell lg:px-4">
          Parking
        </AdminTableTh>
