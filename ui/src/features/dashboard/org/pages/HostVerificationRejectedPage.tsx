    ...
    <div className="bg-background flex min-h-[100dvh] items-center justify-center px-4 py-10">
      ...
      >
        ...
        <p className="text-muted-foreground mt-3 text-sm leading-relaxed">
          {organizationName
            ? `We're sorry — ${organizationName} did not pass host verification, so this account no longer has access to Kame Homes.`
            : "We're sorry — this account did not pass host verification, so it no longer has access to Kame Homes."}
        </p>
        <p className="text-muted-foreground mt-3 text-sm leading-relaxed">
