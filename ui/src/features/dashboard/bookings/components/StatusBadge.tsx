...
export const STATUS_TONE_STYLES: Record<StatusTone, StatusToneStyle> = {
  ...
  green: {
    badge:
      'border-primary/30 bg-primary/[0.08] text-primary dark:border-primary/35 dark:bg-primary/12 dark:text-primary',
  ...
  purple: {
    badge: 'border-border/80 bg-muted/70 text-muted-foreground dark:border-border dark:bg-muted/50',
  ...
  return (
    <span
      className={cn(
        ...
        'whitespace-nowrap text-xs font-semibold leading-tight tracking-tight',
