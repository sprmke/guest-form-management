    ...
    <ResponsiveModal open={open} onOpenChange={onOpenChange}>
      <ResponsiveModalContent className="w-[calc(100vw-1.5rem)] max-w-[calc(100vw-1.5rem)] sm:w-full sm:max-w-md">
        ...
        {step === 'dates' ? (
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                ...
                <DatePicker
                  ...
                  rangeEnd={checkIn}
                  minDate={
                    checkIn ? stringToDate(getNextDay(dateToString(checkIn))) : startOfToday()
                  }
          ...
          <div className="border-border/60 bg-muted/30 my-1 space-y-1 rounded-lg border px-3 py-2.5 text-sm">
        ...
        <ResponsiveModalFooter className="flex-col gap-2 sm:flex-row sm:justify-end">
          {step === 'dates' ? (
            <>
              <Button
                type="button"
