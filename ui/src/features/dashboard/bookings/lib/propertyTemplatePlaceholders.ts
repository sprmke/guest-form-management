/**
 * Property template placeholders — keep in sync with
 * `supabase/functions/_shared/propertyTemplatePlaceholders.ts`.
 */
...
export function applyPropertyTemplatePlaceholders(html: string): string {
  let out = html;
