...
function FinanceTransactionCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex items-center justify-between gap-2 border-t border-separator bg-muted/20 px-3.5 py-2 sm:px-4 sm:py-2.5 dark:bg-muted/30">
        <span
          className={cn(
            'min-w-0 truncate text-base font-bold tabular-nums',
            item.kind === 'income'
