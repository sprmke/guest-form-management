/** Guest-facing copy for parking registration and success states. */
export const PARKING_REGISTRATION_FORM_NAME = 'Parking request';

/** Mid-flow — request created, match + payment still ahead. Never imply booking is confirmed. */
