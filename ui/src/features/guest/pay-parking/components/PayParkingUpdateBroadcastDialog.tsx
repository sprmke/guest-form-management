...
> = {
  submit: {
    ...
    description: 'Notify parking owners by email, or save vehicle details without sending email.',
  ...
  update: {
    ...
    description: 'Notify parking owners again, or save changes without sending email.',
