...
Trivial fixes (typos, internal renames with no behavior/API/UX impact) don't need doc updates — everything else does. Doc index: `docs/README.md`. Full rules/skills index: `.cursor/rules/README.md` · Claude: `.claude/README.md`. Skills: `documentation-maintenance`, `docs-first`, `route-guides`, `plans-and-permissions`.
